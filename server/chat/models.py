...
class ChatSession(models.Model):
    ...
    conversation_summary = models.TextField(
        blank=True,
        default='',
        help_text='Rolling summary of conversation for router context'
    )
...
class RouteDecision(models.Model):
    ...
    session_action = models.CharField(
        max_length=20,
        choices=SessionAction.choices,
        default=SessionAction.CONTINUE
    )
...
class BraintrustLog(models.Model):
    ...
    braintrust_input = models.JSONField(null=True, blank=True, help_text='Full input payload for Braintrust')
    braintrust_output = models.JSONField(null=True, blank=True, help_text='Full output payload for Braintrust')
    braintrust_metadata = models.JSONField(null=True, blank=True, help_text='Additional metadata for Braintrust')
