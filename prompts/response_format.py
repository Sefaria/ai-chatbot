"""Response format prompt — injected into the core agent's system prompt.
...
PROMPT = read_prompt_text("response_format")
...
if __name__ == "__main__":
    ...
    if not slug_override and push_target != "prod":
        print(
            ...
            f"    PROMPT_SLUG_OVERRIDE={SLUG}-yourname-test python prompts/response_format.py\n"
            "\n"
